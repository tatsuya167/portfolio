    ...
    return (
        <section id="header">
            ...
            <div className="mount-1">
                <svg width="901" height="767" viewBox="0 0 901 767" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mount-2">
                <svg width="455" height="649" viewBox="0 0 455 649" fill="none" xmlns="http://www.w3.org/2000/svg">
